...
const LOI_NHAC = {
  ...
  'viet-bai': {
    ...
    loiNhac: [
      ...
      '- truCot va chanDung la ngu canh nghiep vu: bai phai phuc vu dung muc dich/noi dau/mong muon do.',
      '- hoSo, sanPham va insight la SU THAT duoc phep dung. Truong nao null/vang mat thi KHONG tu bia.',
      '- Khong bia gia, ket qua, feedback, con so, case study, tinh nang hay loi ich khong co trong du lieu.',
      '- Neu dung mot insight co bangChung, khong duoc phong dai bangChung thanh mot ket luan manh hon du lieu goc.',
      ...
      '- hashtag la mang 0-5 hashtag lien quan; noiDung KHONG lap lai hashtag; khong nhoi hashtag chung chung.',
  ...
  'viet-kich-ban': {
    ...
    loiNhac: [
      'Viet MOT kich ban quay co cau truc tu yTuong trong du lieu nguoi dung.',
      '- Day la kich ban PHAN CANH, khong phai mot doan van. Tao 4-7 canh theo thu tu quay.',
      '- Tong thoi luong muc tieu 20-60 giay. Moi thoiLuongGiay la so nguyen 2-15 giay.',
      '- Canh dau phai vao thang hook/van de; khong chao hoi, khong mo dau kieu "hom nay minh se chia se".',
      '- Mach uu tien: hook -> van de/boi canh -> demo/giai phap -> giai thich/bang chung co that -> MOT CTA.',
      '- hinhAnh phai mo ta thu co the QUAY DUOC: chu the, hanh dong, goc may/B-roll va boi canh. Uu tien cach quay don gian bang dien thoai cho chu shop nho.',
      '- loiThoai la cau NOI DUOC thanh tieng, tieng Viet co dau day du, ngan va tu nhien. Khong bien no thanh caption dai.',
      '- yTuong, truCot va chanDung la huong da chot. Kich ban phai phuc vu dung noi dau/mong muon cua chanDung va muc dich truCot.',
      '- hoSo, sanPham va insight la SU THAT duoc phep dung. Truong nao null/vang mat thi KHONG tu bia.',
      '- TUYET DOI khong bia gia, ty le %, so don, ket qua, feedback, case study, tinh nang, uu dai hay bang chung khong co trong duLieuVao.',
      '- Neu insight chi noi mot xu huong dinh tinh thi khong duoc tu chen so %. Neu bangChung co so lieu thi giu dung boi canh cua no.',
      '- kichBanGanDay chi dung de tranh lap hook/goc ke; khong sao chep lai kich ban cu.',
      '- MOT kich ban chi co MOT y chinh va MOT CTA cuoi. Neu sanPham khong co CTA thi dung CTA mem, khong bia khuyen mai.',
      CHUNG,
